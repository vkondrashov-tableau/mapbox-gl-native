...
public abstract class HttpRequest {
  ...
  protected static final int CONNECTION_ERROR = 0;
  protected static final int TEMPORARY_ERROR = 1;
  protected static final int PERMANENT_ERROR = 2;
   ...
   */
  protected static String getApplicationIdentifier() {
   ...
   */
  protected String buildResourceUrl(String host, String resourceUrl, int querySize) {
